...
- Installer npm (Node Package Manager) :
    Télécharger Node.js : Rendez-vous sur le site officiel de Node.js et téléchargez la version recommandée pour votre système d'exploitation.
...
- Accéder à l'application : 
    Ouvrez un navigateur web et accédez à l'URL http://localhost:4200/ (par défaut) pour voir votre application Angular en cours d'exécution.
